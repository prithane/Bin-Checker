...
async def start(event):
    ...
    [Button.url("Mʏ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/prithane/Bin-Checker")]
    ])
...
"""
    await event.reply(text, buttons=[[Button.url("Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/prithane/Bin-Checker")]])
